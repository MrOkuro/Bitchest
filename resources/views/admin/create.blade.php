...
<div class="container">
    ...
    <div class="col-md-8 col-md-offset-2">
            ...
            <div class="col-md-3">
                ...
                <input id="email" type="text" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }} " name="email" value="{{ old('email') }}" placeholder="vidéo" autofocus>
                @if ($errors->has('email'))
                    <div class="help-block text-danger font-italic"></div>
                @endif
            </div>
            ...
            <div class="col-md-3">
                ...
                <input id="password" type="text" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }} " name="password" value="{{ old('password') }}" placeholder="durée" autofocus>
